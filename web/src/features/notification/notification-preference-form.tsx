...
import type { NotificationPreferenceItem } from '@/api/types.ts'
import { useNotificationPreferences, useUpdateNotificationPreferences } from './use-notification-preferences.ts'
