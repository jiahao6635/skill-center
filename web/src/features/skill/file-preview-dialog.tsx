...
import { CodeRenderer } from './code-renderer.tsx'
import { toast } from '@/shared/lib/toast.ts'
import { copyToClipboard } from '@/shared/lib/clipboard.ts'
import { getFileTypeLabel, canPreviewFile, getLanguageForHighlight } from './file-type-utils.ts'
import type { FileTreeNode } from './file-tree-builder.ts'
