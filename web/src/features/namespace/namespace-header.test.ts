...
import type { Namespace } from '@/api/types.ts'
import { NamespaceHeader } from './namespace-header.tsx'
import * as mod from './namespace-header.tsx'
...
describe('NamespaceHeader', () => {
  ...
  it('renders the GLOBAL namespace header with avatar, description, slug and immutable hint', () => {
    ...
    expect(html).toContain('alt="Skill Center"')
