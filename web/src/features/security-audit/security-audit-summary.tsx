...
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogDescription } from '@/shared/ui/dialog.tsx'
import { useSecurityAudits } from './use-security-audit.ts'
import { getSecurityAuditDisplayState } from './display-state.ts'
import { VerdictBadge } from './verdict-badge.tsx'
import { SecurityAuditSection } from './security-audit-section.tsx'
