...
import { buildNamespaceReviewDetailPath } from '@/features/review/review-paths.ts'
...
import { useNamespaceDetail } from '@/shared/hooks/use-namespace-queries.ts'
import { useReviewList } from '@/features/review/use-review-list.ts'
