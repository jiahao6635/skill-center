...
public class RouteSecurityPolicyRegistry {
    ...
    private static final List<ApiTokenPolicy> API_TOKEN_POLICIES = List.of(
            ...
            ApiTokenPolicy.require(HttpMethod.POST, "/api/v1/skills/by-id/*/versions", "skill:publish"),
            ...
            ApiTokenPolicy.require(HttpMethod.POST, "/api/web/skills/by-id/*/versions", "skill:publish"),
